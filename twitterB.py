...
# setup search terms
# "#dowjones", "#sp500", "#bitcoin" , "#nasdaq100", "#aapl"
# track = ['#dowjones', '#sp500', '#bitcoin', '#nasdaq100', '#aapl']
...
lakers = ['#lakers', '#lal', '#lbj', '#lakernation', '#lebron', '#lebronjames', '#kobe', '#losangeleslakers', '#lalakers', '#anthonydavis']
raptors = ['#raptors', '#torontoraptors', '#wethenorth', '#kylelowry', '#siakam', '#raptornation', '#nabchamps2019','#freddy', '#steadyfreddy', '#raptorswin']
knicks = ['#nyknicks', '#knicks', '#knicksfan' ,'#knickstape', '#knicksnation', '#newyorkknicks', '#msg', '#nyknicksbasketball', '#rjbarrett', '#nyk']
warriors = ['#warriors', '#goldenstatewarriors', '#stephcurry', '#stephencurry', '#dubnation', '#gsw', '#warriorsnation', '#klaythompson', '#deangelorussell', '#warriorsground']
bulls = ['#chicagobulls', '#bulls' ,'#jordan' , '#michaeljordan' , '#bullsnation', '#bullsoutsiders', '#zachlavine', '#firegarpax', '#bullswin', '#scottiepippen']
hashtags = lakers + raptors + knicks + warriors + bulls
